...
test('TC02 Search Batch ID', async ({ page }) => {
  ...
  await page.waitForTimeout(1000);
  await page.getByLabel('Batch ID').fill('11600');
  await page.getByRole('button', { name: 'Filter' }).click();
  ...
  await page.waitForTimeout(1000);
  await page.getByRole('button', { name: '01900000000000Auto60_1920240401' }).click();
  await expect.soft(page.getByText('E-Document No.01900000000000Auto60_1920240401')).toBeVisible();
  await expect.soft(page.getByText('E-Document No.01900000000000Auto60_1920240401')).toHaveText('E-Document No.01900000000000Auto60_1920240401');
  await page.waitForTimeout(1000);
  ...
  await expect.soft(page.getByText('E-Document No.01900000000000Auto60_1920240401QRPay-inContract No.Auto45_21Create')).toBeHidden();
  await page.waitForTimeout(1000);
...
test('TC04 Export Receipts Multi ', async ({ page }) => {
  ...
  await page.locator('#mat-mdc-checkbox-5').click();
  await page.waitForTimeout(500);
...
test('TC07 Click E-Document No. ', async ({ page }) => {
  ...
  await page.getByRole('menuitem', { name: 'Contract No' }).click();
  await page.waitForTimeout(1000);
  await page.getByLabel('Contract No').fill('TC8-0504');
  await page.getByRole('button', { name: 'Filter' }).click();
  await page.getByRole('menuitem', { name: 'Batch Status' }).hover();
  await page.getByRole('menuitem', { name: 'Completed' }).click();
  await page.getByRole('button', { name: 'Search' }).first().click();
  await page.waitForTimeout(5000);
  await page.getByRole('button', { name: '008000000000000TC8-050420240401' }).click();
  await page.waitForTimeout(1000);
  await expect(page.getByRole('dialog').getByText('E-Document No.'))
    .toHaveText('E-Document No.');
  await expect(page.getByRole('dialog').getByText('008000000000000TC8-050420240401'))
    .toHaveText('008000000000000TC8-050420240401');
  await expect(page.getByText('Contract No.TC8-0504')).toHaveText('Contract No.TC8-0504');
  await page.waitForTimeout(1000);
...
test('TC08 Click Contract No Basic ', async ({ page }) => {
  ...
  await page.getByRole('menuitem', { name: 'Contract No' }).click();
  await page.waitForTimeout(1000);
  await page.getByLabel('Contract No').fill('TC6_relate3_2504');
  await page.getByRole('button', { name: 'Filter' }).click();
  await page.getByRole('menuitem', { name: 'Batch Status' }).hover();
  await page.getByRole('menuitem', { name: 'Completed' }).click();
  await page.getByRole('button', { name: 'Search' }).first().click();
  await page.waitForTimeout(5000);
  await page.getByRole('button', { name: 'TC6_relate3_2504', exact: true }).click();
  await page.waitForTimeout(1000);
  await expect.soft(page.getByRole('heading', { name: 'History for \'TC6_relate3_2504\'' })).toBeVisible();
