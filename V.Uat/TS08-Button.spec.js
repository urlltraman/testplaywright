...
test('TC06 Refresh ', async ({ page }) => {
    ...
    let mask_locator = await page.getByRole('row', { name: 'kittisak.p@ginkgosoft.co.th' }).getByRole('cell').nth(2);
    ...
    await page.getByRole('row', { name: 'kittisak.p@ginkgosoft.co.th' }).first().getByRole('button').nth(1).click();
...
test('TC10 Monthly E-Stamp 1 - 6  ', async ({ page }) => {
    ...
    await page.getByRole('button', { name: 'Ginkgo Soft Co., Ltd. (บริษัท กิงโกะ ซอฟต์ จำกัด)' }).click();
    await page.waitForTimeout(500);
    await page.getByRole('button', { name: 'Ginkgo Soft Co., Ltd. (Demo' }).click();
    await page.waitForTimeout(1000);
    ...
    await page.waitForTimeout(2000);
    await page.locator('div').filter({ hasText: /^Select Month2024-02$/ }).nth(2).click();
...
test('TC10 Monthly E-Stamp 7 - 12  ', async ({ page }) => {
    ...
    await page.waitForTimeout(2000);
    await page.locator('div').filter({ hasText: /^Select Month2023-08$/ }).nth(2).click();
    ...
    await page.waitForTimeout(2000);
    await page.locator('div').filter({ hasText: /^Select Month2023-07$/ }).nth(2).click();
