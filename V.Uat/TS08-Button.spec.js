...
test('TC03 Report Account ', async ({ page }) => {
    ...
    const download1 = await downloadPromise1;
    // Save downloaded file somewhere
    await download1.saveAs('Output/TS08-Button/TC03 Monthly Account/07.Report Account Month 01.xlsx');
    await page.waitForTimeout(1000);
    ...
    const download2 = await downloadPromise2;
    // Save downloaded file somewhere
    await download2.saveAs('Output/TS08-Button/TC03 Monthly Account/08.Report Account Month 12.xlsx');
    await page.waitForTimeout(1000);
    ...
    // Save downloaded file somewhere
    await download3.saveAs('Output/TS08-Button/TC03 Monthly Account/09.Report Account Month 11.xlsx');
    await page.waitForTimeout(1000);
    ...
    // Save downloaded file somewhere
    await download4.saveAs('Output/TS08-Button/TC03 Monthly Account/10.Report Account Month 10.xlsx');
    await page.waitForTimeout(1000);
    ...
    // Save downloaded file somewhere
    await download5.saveAs('Output/TS08-Button/TC03 Monthly Account/11.Report Account Month 09.xlsx');
    await page.waitForTimeout(1000);
    ...
    // Save downloaded file somewhere
    await download6.saveAs('Output/TS08-Button/TC03 Monthly Account/12.Report Account Month 08.xlsx');
    await page.waitForTimeout(1000);
    ...
    // Save downloaded file somewhere
    await download7.saveAs('Output/TS08-Button/TC03 Monthly Account/13.Report Account Month 07.xlsx');
    await page.waitForTimeout(1000);
    ...
    // Save downloaded file somewhere
    await download8.saveAs('Output/TS08-Button/TC03 Monthly Account/14.Report Account Month 06.xlsx');
    await page.waitForTimeout(1000);
    ...
    // Save downloaded file somewhere
    await download9.saveAs('Output/TS08-Button/TC03 Monthly Account/15.Report Account Month 05.xlsx');
    await page.waitForTimeout(1000);
    ...
    // Save downloaded file somewhere
    await download10.saveAs('Output/TS08-Button/TC03 Monthly Account/16.Report Account Month 04.xlsx');
    await page.waitForTimeout(1000);
    ...
    // Save downloaded file somewhere
    await download11.saveAs('Output/TS08-Button/TC03 Monthly Account/17.Report Account Month 03.xlsx');
    await page.waitForTimeout(1000);
    ...
    // Save downloaded file somewhere
    await download12.saveAs('Output/TS08-Button/TC03 Monthly Account/18.Report Account Month 02.xlsx');
    await page.waitForTimeout(1000);
