...
test('TC40 ActionType Case 1 6 - 9.2 ', async ({ page }) => {
    // C6
    await page.waitForURL('/batch');
    await page.getByRole('button', { name: 'Upload' }).first().click();
...
test('TC40 ActionType Case 2 1 - 5 ', async ({ page }) => {
    ...
    await expect.soft(page.getByLabel('Message')).toBeVisible();
    await expect.soft(page.getByLabel('Message'))
        .toHaveText("Messageข้อมูลบรรทัดที่ 1 column 'actionType' typeCode is equal to 2, 3, 6, 7, 8, 111, 14, 15, 17, 18, 21, 271, or 272; therefore, actionType must not be empty. [R21] ");
    await page.waitForTimeout(500);
    ...
    await expect.soft(page.locator('.card-error')).toBeVisible();
    await expect.soft(page.locator('.card-error'))
        .toHaveText("errorInput Errorข้อมูลบรรทัดที่ 1 column 'actionType' typeCode is equal to 2, 3, 6, 7, 8, 111, 14, 15, 17, 18, 21, 271, or 272; therefore, actionType must not be empty. [R21] Import FixesExport FixesEdit");
    await page.waitForTimeout(500);
...
test('TC40 ActionType Case 2 6 - 9.2 ', async ({ page }) => {
    ...
    await expect.soft(page.getByLabel('Message')).toBeVisible();
    await expect.soft(page.getByLabel('Message'))
        .toHaveText("Messageข้อมูลบรรทัดที่ 1 column 'actionType' typeCode is one of 7,111,271,272; therefore, attachDetail.actionType must be equal to 1, 2, or 3. [E07265] ข้อมูลบรรทัดที่ 1 column 'actionType' typeCode is equal to 2, 3, 6, 7, 8, 111, 14, 15, 17, 18, 21, 271, or 272; therefore, actionType must not be empty. [R21] ");
    await page.waitForTimeout(500);
    ...
    await expect.soft(page.getByLabel('Message')).toBeVisible();
    await expect.soft(page.getByLabel('Message'))
        .toHaveText("Messageข้อมูลบรรทัดที่ 1 column 'actionType' typeCode is one of 8,14,15,18,21; therefore, attachDetail.actionType must be equal to 1 or 2. [E07265] ข้อมูลบรรทัดที่ 1 column 'actionType' typeCode is equal to 2, 3, 6, 7, 8, 111, 14, 15, 17, 18, 21, 271, or 272; therefore, actionType must not be empty. [R21] ");
    await page.waitForTimeout(500);
...
test('TC40 ActionType Case 3 1 - 5 ', async ({ page }) => {
    ...
    await expect.soft(page.getByLabel('Message')).toBeVisible();
    await expect.soft(page.getByLabel('Message'))
        .toHaveText("Messageข้อมูลบรรทัดที่ 1 column 'actionType' length is overflow ");
    await page.waitForTimeout(500);
    ...
    await expect.soft(page.locator('.card-error')).toBeVisible();
    await expect.soft(page.locator('.card-error'))
        .toHaveText("errorInput Errorข้อมูลบรรทัดที่ 1 column 'actionType' length is overflow Import FixesExport FixesEdit");
    await page.waitForTimeout(500);
    ...
    await expect.soft(page.locator('.card-error')).toBeVisible();
    await expect.soft(page.locator('.card-error'))
        .toHaveText("errorInput ErrorG2 Import FixesExport FixesEdit");
    await page.waitForTimeout(500);
    ...
    await expect.soft(page.locator('.card-error')).toBeVisible();
    await expect.soft(page.locator('.card-error'))
        .toHaveText("errorInput ErrorG3 Import FixesExport FixesEdit");
    await page.waitForTimeout(500);
    ...
    await expect.soft(page.locator('.card-error')).toBeVisible();
    await expect.soft(page.locator('.card-error'))
        .toHaveText("errorInput ErrorG4 Import FixesExport FixesEdit");
    await page.waitForTimeout(500);
