...
test('TC07 Click E-Document No. ', async ({ page }) => {
  ...
  await page.getByRole('button', { name: 'Search' }).first().click();
  await page.waitForTimeout(5000);
  await page.getByRole('button', { name: '001000000000000ABC100032023070201' }).click();
  await page.waitForTimeout(1000);
  await expect(page.getByRole('dialog').getByText('E-Document No.'))
    .toHaveText('E-Document No.');
  await expect(page.getByRole('dialog').getByText('001000000000000ABC100032023070201'))
    .toHaveText('001000000000000ABC100032023070201');
