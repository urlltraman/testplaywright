...
test('TC31 District 5 - 8 ', async ({ page }) => {
    ...
    await expect.soft(page.getByLabel('Message'))
        .toHaveText("Messageข้อมูลบรรทัดที่ 1 column 'district' invalid special character ข้อมูลบรรทัดที่ 1 column 'district' invalid character. ");
    await page.waitForTimeout(500);
    ...
    await expect.soft(page.locator('.card-error'))
        .toHaveText("errorInput Errorข้อมูลบรรทัดที่ 1 column 'district' invalid special character ข้อมูลบรรทัดที่ 1 column 'district' invalid character. Import FixesExport FixesEdit");
    await page.waitForTimeout(500);
...
test('TC32 Province 5 - 8 ', async ({ page }) => {
    ...
    await expect.soft(page.getByLabel('Message')).toBeVisible();
    await expect.soft(page.getByLabel('Message'))
        .toHaveText("Messageข้อมูลบรรทัดที่ 1 column 'province' invalid special character ข้อมูลบรรทัดที่ 1 column 'province' invalid character. ");
    await page.waitForTimeout(500);
    ...
    await expect.soft(page.locator('.card-error')).toBeVisible();
    await expect.soft(page.locator('.card-error'))
        .toHaveText("errorInput Errorข้อมูลบรรทัดที่ 1 column 'province' invalid special character ข้อมูลบรรทัดที่ 1 column 'province' invalid character. Import FixesExport FixesEdit");
    await page.waitForTimeout(500);
...
test('TC34 Total Party 11 - 13 ', async ({ page }) => {
    ...
    await expect.soft(page.getByLabel('Message')).toBeVisible();
    await expect.soft(page.getByLabel('Message'))
        .toHaveText("Messageข้อมูลบรรทัดที่ 1 column 'totalParty' invalid special character ข้อมูลบรรทัดที่ 1 column 'totalParty' is an invalid number ข้อมูลบรรทัดที่ 1 column 'relateParty' totalParty must be integer. ");
    await page.waitForTimeout(500);
    ...
    await expect.soft(page.locator('.card-error')).toBeVisible();
    await expect.soft(page.locator('.card-error'))
        .toHaveText("errorInput Errorข้อมูลบรรทัดที่ 1 column 'totalParty' invalid special character ข้อมูลบรรทัดที่ 1 column 'totalParty' is an invalid number ข้อมูลบรรทัดที่ 1 column 'relateParty' totalParty must be integer. Import FixesExport FixesEdit");
    await page.waitForTimeout(500);
