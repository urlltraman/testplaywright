...
test('TC74 Relate Inst Info OS4 1 - 3  ', async ({ page }) => {
    ...
    await page.waitForTimeout(500);
    await page.screenshot({ path: 'Output/TS11-Input Validation/TC74. Relate Inst Info/04. OS4/04. Case 3 Click Status Error Msg.png' });
    await page.waitForTimeout(500);
    await page.reload();
    await page.getByText('Auto_RelateInstInfoOS4_C3').first().click();
    await expect.soft(page.locator('.card-error')).toBeVisible();
    await expect.soft(page.locator('.card-error'))
        .toHaveText("errorInput ErrorG3  Import FixesExport FixesEdit");
    await page.waitForTimeout(500);
    await page.screenshot({ path: 'Output/TS11-Input Validation/TC74. Relate Inst Info/04. OS4/05. Case 3 Error Msg.png' });
    await page.locator('a').filter({ hasText: 'Batch' }).click();
...
test('TC75 Relate Party 1 - 5  ', async ({ page }) => {
    ...
    await expect.soft(page.getByLabel('Message')).toBeVisible();
    await expect.soft(page.getByLabel('Message'))
        .toHaveText("Messageข้อมูลบรรทัดที่ 1 column 'relateParty' relatePartyBranchNo is empty; therefore, relatePartyBranchType must be 'O'. [R13]  ");
    await page.waitForTimeout(500);
    ...
    await expect.soft(page.locator('.card-error')).toBeVisible();
    await expect.soft(page.locator('.card-error'))
        .toHaveText("errorInput Errorข้อมูลบรรทัดที่ 1 column 'relateParty' relatePartyBranchNo is empty; therefore, relatePartyBranchType must be 'O'. [R13]  Import FixesExport FixesEdit");
    await page.waitForTimeout(500);
    ...
    await expect.soft(page.getByLabel('Message')).toBeVisible();
    await expect.soft(page.getByLabel('Message'))
        .toHaveText("Messageข้อมูลบรรทัดที่ 1 column 'relatePartyId' is an invalid TaxID format ข้อมูลบรรทัดที่ 1 column 'relatePartyId' is an invalid TaxID format  ");
    await page.waitForTimeout(500);
    ...
    await expect.soft(page.locator('.card-error')).toBeVisible();
    await expect.soft(page.locator('.card-error'))
        .toHaveText("errorInput Errorข้อมูลบรรทัดที่ 1 column 'relatePartyId' is an invalid TaxID format ข้อมูลบรรทัดที่ 1 column 'relatePartyId' is an invalid TaxID format  Import FixesExport FixesEdit");
    await page.waitForTimeout(500);
