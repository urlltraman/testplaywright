...
test('TC13 Send Form Type 12 - 14  ', async ({ page }) => {
    ...
    await expect.soft(page.getByLabel('Message')).toBeVisible();
    await expect.soft(page.getByLabel('Message'))
        .toHaveText("Messageข้อมูลบรรทัดที่ 2 column 'contractNo'  'tgv-1223s-as54' is not exist in os9 new entry or os4 paper stamp. ");
    await page.waitForTimeout(500);
    ...
    await expect.soft(page.locator('.card-error')).toBeVisible();
    await expect.soft(page.locator('.card-error'))
        .toHaveText("errorInput Errorข้อมูลบรรทัดที่ 2 column 'contractNo'  'tgv-1223s-as54' is not exist in os9 new entry or os4 paper stamp. Import FixesExport FixesEdit");
    await page.waitForTimeout(500);
    ...
    await expect.soft(page.getByLabel('Message')).toBeVisible();
    await expect.soft(page.getByLabel('Message'))
        .toHaveText("Messageข้อมูลบรรทัดที่ 1 column 'contractNo'  'tgv-1223s-a' is not exist in os9 new entry or os4 paper stamp. ข้อมูลบรรทัดที่ 1 column 'filingNo' Incorrect  ");
    await page.waitForTimeout(500);
    ...
    await expect.soft(page.locator('.card-error')).toBeVisible();
    await expect.soft(page.locator('.card-error'))
        .toHaveText("errorInput Errorข้อมูลบรรทัดที่ 1 column 'contractNo'  'tgv-1223s-a' is not exist in os9 new entry or os4 paper stamp. ข้อมูลบรรทัดที่ 1 column 'filingNo' Incorrect  Import FixesExport FixesEdit");
    await page.waitForTimeout(500);
