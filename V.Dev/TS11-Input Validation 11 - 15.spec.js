...
test('TC13 Send Form Type 12 - 14  ', async ({ page }) => {
    ...
    await page.waitForTimeout(1500);
    await page.waitForURL('/batch');
    await page.screenshot({ path: 'Output/TS11-Input Validation/TC13. Send Form Type/28. Case 12.png' });
    await page.waitForTimeout(1500);
    await page.getByRole('button', { name: 'Search' }).first().click();
    await page.waitForTimeout(1000);
    ...
    await page.waitForTimeout(500);
    await page.screenshot({ path: 'Output/TS11-Input Validation/TC13. Send Form Type/29. Case 12 Click Status Error Msg.png' });
    await page.waitForTimeout(500);
    await page.reload();
    ...
    await page.waitForTimeout(500);
    await page.screenshot({ path: 'Output/TS11-Input Validation/TC13. Send Form Type/30. Case 12 Error Msg.png' });
    await page.locator('a').filter({ hasText: 'Batch' }).click();
    ...
    await page.screenshot({ path: 'Output/TS11-Input Validation/TC13. Send Form Type/31. Case 13.png', mask: [mask_locator5], maskColor: '#00FF00' });
    await page.waitForTimeout(1500);
    await page.getByRole('button', { name: 'Search' }).first().click();
    await page.waitForTimeout(500);
    await page.locator('button').filter({ hasText: 'Input Error' }).first().click();
    ...
    await page.waitForTimeout(500);
    await page.screenshot({ path: 'Output/TS11-Input Validation/TC13. Send Form Type/32. Case 13 Click Status Error Msg.png' });
    await page.waitForTimeout(500);
    await page.reload();
    ...
    await page.waitForTimeout(500);
    await page.screenshot({ path: 'Output/TS11-Input Validation/TC13. Send Form Type/33. Case 13 Error Msg.png' });
    await page.locator('a').filter({ hasText: 'Batch' }).click();
    ...
    await page.screenshot({ path: 'Output/TS11-Input Validation/TC13. Send Form Type/34. Case 14.png', mask: [mask_locator6], maskColor: '#00FF00' });
    await page.waitForTimeout(1500);
    await page.getByRole('button', { name: 'Search' }).first().click();
    await page.waitForTimeout(500);
    await page.locator('button').filter({ hasText: 'Input Error' }).first().click();
    ...
    await page.waitForTimeout(500);
    await page.screenshot({ path: 'Output/TS11-Input Validation/TC13. Send Form Type/35. Case 14 Click Status Error Msg.png' });
    await page.waitForTimeout(500);
    await page.reload();
    ...
    await page.waitForTimeout(500);
    await page.screenshot({ path: 'Output/TS11-Input Validation/TC13. Send Form Type/36. Case 14 Error Msg.png' });
    await page.locator('a').filter({ hasText: 'Batch' }).click();
