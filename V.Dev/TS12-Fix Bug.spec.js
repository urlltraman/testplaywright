...
test('GSD-103 ', async ({ page }) => {
    ...
    await expect.soft(page.getByText('17*****82')).toHaveText('17*****82');
    await page.waitForTimeout(500);
...
test('GSD-125 ', async ({ page }) => {
    ...
    await page.getByRole('button', { name: 'Receipts', exact: true }).first().click();
...
test('GSD-127 ', async ({ page }) => {
    ...
    await expect.soft(page.getByText('17*****82')).toHaveText('17*****82');
    await page.getByText('17*****82').hover();
    await page.waitForTimeout(1500);
...
test('GSD-128 ', async ({ page }) => {
    ...
    await page.waitForTimeout(1000);
    await page.getByRole('row', { name: 'Ge*****ty     ge*****om GGT,' }).getByRole('button').first().click();
    await page.waitForTimeout(2000);
...
//     await page.getByRole('link', { name: 'User Accounts' }).click();
//     await page.getByRole('combobox').selectOption('50');
//     await page.getByRole('row', { name: 'te*****om te*****om GGS', exact: true }).getByRole('button').first().click();
//     await page.waitForTimeout(1000);
...
test('GSD-142 ', async ({ page }) => {
    ...
    await expect.soft(page.getByRole('cell', { name: 'GinkgoTest กิงโกะเทส' })).toHaveText('GinkgoTestกิงโกะเทส');
...
//     await page.getByRole('combobox').selectOption('50');
//     await page.waitForTimeout(1000);
//     await page.getByRole('row', { name: 'te*****om te*****om GGT' }).getByRole('button').first().click();
//     await page.waitForTimeout(1000);
//     await page.getByText('User Locked Out').click();
//     await page.getByRole('button', { name: 'Save' }).click();
//     await page.waitForTimeout(1000);
...
test('GSD-172 ', async ({ page }) => {
    ...
    await page.getByRole('combobox').selectOption('50');
    await page.waitForTimeout(800);
    await page.getByRole('row', { name: 'mo*****om mo*****om GGS' }).getByRole('button').first().click();
    await page.waitForTimeout(500);
...
test('GSD-211 ', async ({ page }) => {
    ...
    await page.getByRole('button', { name: 'Refresh' }).click();
    const downloadPromiseA = page.waitForEvent('download');
    await page.getByRole('row', { name: 'test.gamekittisak7@gmail.com' }).getByRole('button').nth(1).click();
    const downloadA = await downloadPromiseA;
    // Save downloaded file somewhere
...
test('GSD-213 ', async ({ page }) => {
    ...
    await page.getByRole('button', { name: 'Close' }).click();
    await page.waitForTimeout(1500);
    await page.locator('td:nth-child(51)').click();
    ...
    await page.getByRole('button', { name: 'Close' }).click();
    await page.waitForTimeout(1500);
    await page.locator('td:nth-child(52)').click();
...
test('GSD-219 ', async ({ page }) => {

    await page.waitForURL('/batch');
    await page.getByRole('button', { name: 'Upload' }).first().click();
    await page.locator('#file').setInputFiles('Data Files/Fix Bug/GSD-219/Auto_GSD-219.xlsx');
    await page.getByRole('button', { name: 'Upload' }).click();
    await page.getByLabel('Upload Success').click();
    await expect(page.getByRole('heading', { name: 'Upload Success' })).toHaveText('Upload Success');
    await page.getByRole('button', { name: 'Close' }).click();
    ...
    await page.waitForTimeout(2500);
    await page.waitForURL('/batch');
    let mask_locator3 = await page.getByRole('row', { name: 'Auto_GSD-219' }).getByRole('cell').first();
    await page.screenshot({ path: 'Output/TS12-Fix Bug/GSD-219/01. GSD-219.png', mask: [mask_locator3], maskColor: '#00FF00' });
    await page.waitForTimeout(1500);
    await page.getByRole('button', { name: 'Search' }).first().click();
    await page.waitForTimeout(500);
    await page.reload();
    await page.getByText('Auto_GSD-219').first().click();
    await page.waitForTimeout(500);
    await expect.soft(page.getByText('Total InstAmount88,000.00')).toHaveText('Total InstAmount88,000.00');
    await expect.soft(page.getByText('Total Paid Amount44.00')).toHaveText('Total Paid Amount44.00');
    await expect.soft(page.getByText('Stamp Duty Amount44.00')).toHaveText('Stamp Duty Amount44.00');
    await expect.soft(page.getByRole('cell', { name: 'Inst Amount' })).toHaveText('Inst Amount');
    await expect.soft(page.getByRole('cell', { name: '88,000.00' })).toHaveText('88,000.00');
    await page.waitForTimeout(500);
    await page.screenshot({ path: 'Output/TS12-Fix Bug/GSD-219/02. Amount.png' });
    await page.getByRole('cell', { name: 'Form Type' }).first().hover();
    await expect.soft(page.getByRole('cell', { name: 'Form Type', exact: true })).toBeVisible();
    await expect.soft(page.getByRole('cell', { name: 'AS9' })).toHaveText('AS9');
    await expect.soft(page.getByRole('cell', { name: 'Select Type' })).toBeVisible();
    await expect.soft(page.getByRole('cell', { name: 'E', exact: true })).toHaveText('E');
    await page.screenshot({ path: 'Output/TS12-Fix Bug/GSD-219/03. From Type And Select Type.png' });
    await page.waitForTimeout(500);
    await page.getByRole('cell', { name: 'Type', exact: true }).hover();
    await expect.soft(page.getByRole('cell', { name: 'ยื่นปกติ' })).toHaveText('ยื่นปกติ');
    await page.screenshot({ path: 'Output/TS12-Fix Bug/GSD-219/04. Send From Type .png' });
    await page.waitForTimeout(500);
    await page.getByRole('cell', { name: 'TaxPayer' }).hover();
    await expect.soft(page.getByRole('cell', { name: 'TaxPayer' })).toBeVisible();
    await expect.soft(page.getByRole('cell', { name: '0105556078229', exact: true })).toHaveText('0105556078229');
    await page.screenshot({ path: 'Output/TS12-Fix Bug/GSD-219/05. Taxpayer.png' });
    await page.waitForTimeout(500);
    await page.getByRole('cell', { name: 'Brach No.' }).hover();
    await expect.soft(page.getByRole('cell', { name: 'Brach No.' })).toBeVisible();
    await expect.soft(page.getByRole('cell', { name: '123', exact: true })).toHaveText('123');
    await page.screenshot({ path: 'Output/TS12-Fix Bug/GSD-219/06. Brach No.png' });
    await page.waitForTimeout(500);
    await page.getByRole('cell', { name: 'Relationship' }).hover();
    await expect.soft(page.getByRole('cell', { name: 'Relationship' })).toBeVisible();
    await expect.soft(page.getByRole('cell', { name: '1', exact: true }).nth(2)).toHaveText('1');
    await page.screenshot({ path: 'Output/TS12-Fix Bug/GSD-219/07. Relationship.png' });
    await page.waitForTimeout(500);
    await page.locator('a').filter({ hasText: 'Batch' }).click();
    await page.getByRole('row', { name: 'Auto_GSD-219 ' }).first().getByText('delete').click();
    await page.getByRole('button', { name: 'Confirm' }).click();
    await expect.soft(page.getByRole('row', { name: 'Auto_GSD-219  ' })).toBeHidden();
    await page.waitForTimeout(1500);
