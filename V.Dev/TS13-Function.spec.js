...
test('GSD-7', async ({ page }) => {
    ...
    await page.waitForTimeout(1000);
    await page.getByRole('row', { name: 'Test Auto ทดสอบ TA Test Auto ทดสอบ อัตโนมัติ 1 EXPORTER ACCOUNT INFO KEY' }).getByRole('button').nth(3).click();
    await page.waitForTimeout(1000);
...
test('GSD-61 ', async ({ page }) => {
    ...
    await page.waitForURL('/settings/configuration');
    await page.getByRole('link', { name: 'Organization' }).click();
    await page.getByRole('row', { name: 'Ginkgo Soft กิงโกะซอฟต์ GinkgoSoft' }).getByRole('button').first().click();
    await page.waitForTimeout(1500);
...
test('GSD-86 ', async ({ page }) => {
    ...
    await page.waitForTimeout(1000);
    await page.getByRole('row', { name: 'pr*****G] pr*****om Ginkgo Soft กิงโกะซอฟต์ GGS, PAYPAL, GGT' }).getByRole('button').nth(1).click();
    await page.waitForTimeout(1000);
    await page.screenshot({ path: 'Output/TS13-Function/GSD-86/01. Api User.png' });
    await page.getByRole('button', { name: 'Cancel' }).click();
    await page.waitForTimeout(1000);
    await page.getByRole('row', { name: 'Lu*****in lu*****th Ginkgo Soft กิงโกะซอฟต์ GGS, GGT, GDM, FPIT, PAYPAL' }).getByRole('button').nth(1).click();
    await page.waitForTimeout(1000);
...
test('GSD-118 ', async ({ page }) => {
    ...
    await page.getByRole('link', { name: 'Administrator' }).click();
    await page.getByRole('link', { name: 'User Accounts' }).click();
    await page.getByText('Ginkgo Soft Co., Ltd.').first().click();
