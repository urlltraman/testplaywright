...
test('TC08 Select Type 20 - 24  ', async ({ page }) => {
    ...
    await page.screenshot({ path: 'Output/TS11-Input Validation/TC08. Select Type/53. Case 20.png', mask: [mask_locator16], maskColor: '#00FF00' });
    await page.waitForTimeout(1500);
    await page.getByRole('button', { name: 'Search' }).first().click()
    await page.waitForTimeout(500);
    await page.reload();
    ...
    await page.screenshot({ path: 'Output/TS11-Input Validation/TC08. Select Type/56. Case 21.png', mask: [mask_locator17], maskColor: '#00FF00' });
    await page.waitForTimeout(1500);
    await page.getByRole('button', { name: 'Search' }).first().click()
    await page.waitForTimeout(500);
    await page.reload();
    ...
    await page.screenshot({ path: 'Output/TS11-Input Validation/TC08. Select Type/59. Case 22.png', mask: [mask_locator18], maskColor: '#00FF00' });
    await page.waitForTimeout(1500);
    await page.getByRole('button', { name: 'Search' }).first().click()
    await page.waitForTimeout(500);
    await page.reload();
    ...
    await page.screenshot({ path: 'Output/TS11-Input Validation/TC08. Select Type/62. Case 23.png', mask: [mask_locator19], maskColor: '#00FF00' });
    await page.waitForTimeout(1500);
    await page.getByRole('button', { name: 'Search' }).first().click()
    await page.waitForTimeout(500);
    await page.reload();
    ...
    await page.screenshot({ path: 'Output/TS11-Input Validation/TC08. Select Type/65. Case 24.png', mask: [mask_locator1], maskColor: '#00FF00' });
    await page.waitForTimeout(1500);
    await page.getByRole('button', { name: 'Search' }).first().click()
    await page.waitForTimeout(500);
    await page.reload();
    ...
    await page.waitForTimeout(500);
    await page.screenshot({ path: 'Output/TS11-Input Validation/TC08. Select Type/66. Case 24 Click Status Error Msg.png' });
    await page.waitForTimeout(500);
    await page.reload();
    ...
    await page.waitForTimeout(500);
    await page.screenshot({ path: 'Output/TS11-Input Validation/TC08. Select Type/67. Case 24 Error Msg.png' });
    await page.locator('a').filter({ hasText: 'Batch' }).click();
...
test('TC09 Contract No Case 1 6 - 12  ', async ({ page }) => {
    ...
    await expect.soft(page.getByLabel('Message')).toBeVisible();
    await expect.soft(page.getByLabel('Message'))
        .toHaveText("Messageข้อมูลบรรทัดที่ 1 column 'contractNo' 'Auto_HY_003' is Exist.  ");
    await page.waitForTimeout(500);
    ...
    await expect.soft(page.locator('.card-error')).toBeVisible();
    await expect.soft(page.locator('.card-error'))
        .toHaveText("errorInput Errorข้อมูลบรรทัดที่ 1 column 'contractNo' 'Auto_HY_003' is Exist.  Import FixesExport FixesEdit");
    await page.waitForTimeout(500);
...
test('TC10 Creation Date  1 - 5  ', async ({ page }) => {
    ...
    await expect.soft(page.getByLabel('Message')).toBeVisible();
    await expect.soft(page.getByLabel('Message'))
        .toHaveText("Messageข้อมูลบรรทัดที่ 1 column 'creationDate' is an incorrect date formatข้อมูลบรรทัดที่ 1 column 'creationDate' invalid overdueFlag ข้อมูลบรรทัดที่ 1 column 'creationDate' overdueFlag is empty; therefore creationDate must be a date up to 15 days back. [R53.1] ");
    await page.waitForTimeout(500);
    ...
    await expect.soft(page.locator('.card-error')).toBeVisible();
    await expect.soft(page.locator('.card-error'))
        .toHaveText("errorInput Errorข้อมูลบรรทัดที่ 1 column 'creationDate' is an incorrect date formatข้อมูลบรรทัดที่ 1 column 'creationDate' invalid overdueFlag ข้อมูลบรรทัดที่ 1 column 'creationDate' overdueFlag is empty; therefore creationDate must be a date up to 15 days back. [R53.1] Import FixesExport FixesEdit");
    await page.waitForTimeout(500);
    ...
    await expect.soft(page.getByLabel('Message')).toBeVisible();
    await expect.soft(page.getByLabel('Message'))
        .toHaveText("MessageUnparseable date: \"2023/09/01\"");
    await page.waitForTimeout(500);
    ...
    await expect.soft(page.locator('.card-error')).toBeVisible();
    await expect.soft(page.locator('.card-error'))
        .toHaveText("errorInput ErrorUnparseable date: \"2023/09/01\"");
    await page.waitForTimeout(500);
...
test('TC10 Creation Date  6 - 10  ', async ({ page }) => {
    ...
    await expect.soft(page.getByLabel('Message')).toBeVisible();
    await expect.soft(page.getByLabel('Message'))
        .toHaveText("MessageUnparseable date: \"2566/09/01\"");
    await page.waitForTimeout(500);
    ...
    await expect.soft(page.locator('.card-error')).toBeVisible();
    await expect.soft(page.locator('.card-error'))
        .toHaveText("errorInput ErrorUnparseable date: \"2566/09/01\"");
    await page.waitForTimeout(500);
    ...
    await expect.soft(page.getByLabel('Message')).toBeVisible();
    await expect.soft(page.getByLabel('Message'))
        .toHaveText("MessageUnparseable date: \"01/09/2023\" ");
    await page.waitForTimeout(500);
    ...
    await expect.soft(page.locator('.card-error')).toBeVisible();
    await expect.soft(page.locator('.card-error'))
        .toHaveText("errorInput ErrorUnparseable date: \"01/09/2023\"");
    await page.waitForTimeout(500);
    ...
    await expect.soft(page.getByLabel('Message')).toBeVisible();
    await expect.soft(page.getByLabel('Message'))
        .toHaveText("MessageUnparseable date: \"01/09/2566\" ");
    await page.waitForTimeout(500);
    ...
    await expect.soft(page.locator('.card-error')).toBeVisible();
    await expect.soft(page.locator('.card-error'))
        .toHaveText("errorInput ErrorUnparseable date: \"01/09/2566\"");
    await page.waitForTimeout(500);
...
test('TC10 Creation Date  11 - 14  ', async ({ page }) => {
    ...
    await expect.soft(page.getByLabel('Message')).toBeVisible();
    await expect.soft(page.getByLabel('Message'))
        .toHaveText("MessageUnparseable date: \"วันที่ 17 มกราคม สองพันห้าร้อยหกสิบหก\"  ");
    await page.waitForTimeout(500);
    ...
    await expect.soft(page.locator('.card-error')).toBeVisible();
    await expect.soft(page.locator('.card-error'))
        .toHaveText("errorInput ErrorUnparseable date: \"วันที่ 17 มกราคม สองพันห้าร้อยหกสิบหก\"");
    await page.waitForTimeout(500);
    ...
    await expect.soft(page.getByLabel('Message')).toBeVisible();
    await expect.soft(page.getByLabel('Message'))
        .toHaveText("MessageUnparseable date: \"17 June 2023\"  ");
    await page.waitForTimeout(500);
    ...
    await expect.soft(page.locator('.card-error')).toBeVisible();
    await expect.soft(page.locator('.card-error'))
        .toHaveText("errorInput ErrorUnparseable date: \"17 June 2023\"");
    await page.waitForTimeout(500);
    ...
    await expect.soft(page.getByLabel('Message')).toBeVisible();
    await expect.soft(page.getByLabel('Message'))
        .toHaveText("MessageUnparseable date: \"!@#$%^&*()\"  ");
    await page.waitForTimeout(500);
    ...
    await expect.soft(page.locator('.card-error')).toBeVisible();
    await expect.soft(page.locator('.card-error'))
        .toHaveText("errorInput ErrorUnparseable date: \"!@#$%^&*()\"");
    await page.waitForTimeout(500);
...
test('TC10 Creation Date  19 - 22  ', async ({ page }) => {
    ...
    await expect.soft(page.getByLabel('Message')).toBeVisible();
    await expect.soft(page.getByLabel('Message'))
        .toHaveText("Messageข้อมูลบรรทัดที่ 1 column 'creationDate' invalid overdueFlag ข้อมูลบรรทัดที่ 1 column 'creationDate' overdueFlag is empty; therefore creationDate must be a date up to 15 days back. [R53.1]  ");
    await page.waitForTimeout(500);
    ...
    await expect.soft(page.locator('.card-error')).toBeVisible();
    await expect.soft(page.locator('.card-error'))
        .toHaveText("errorInput Errorข้อมูลบรรทัดที่ 1 column 'creationDate' invalid overdueFlag ข้อมูลบรรทัดที่ 1 column 'creationDate' overdueFlag is empty; therefore creationDate must be a date up to 15 days back. [R53.1] Import FixesExport FixesEdit");
    await page.waitForTimeout(500);
