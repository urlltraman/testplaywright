...
test('TC81 R60 District Case 2 TC01 - TC03  ', async ({ page }) => {
    ...
    await expect.soft(page.getByLabel('Message'))
        .toHaveText("Messageข้อมูลบรรทัดที่ 1 column 'district' 'district' is required. [R61] ");
    await page.waitForTimeout(500);
    ...
    await expect.soft(page.locator('.card-error'))
        .toHaveText("errorInput Errorข้อมูลบรรทัดที่ 1 column 'district' 'district' is required. [R61] Import FixesExport FixesEdit");
...
test('TC81 R60 District Case 2 TC11.2 - TC13  ', async ({ page }) => {
    ...
    await expect.soft(page.getByLabel('Message')).toBeVisible();
    await expect.soft(page.getByLabel('Message'))
        .toHaveText("Messageข้อมูลบรรทัดที่ 1 column 'district' selectType is equal to 1; therefore, district must not be empty. [R60] ข้อมูลบรรทัดที่ 1 column 'district' 'district' is required. [R61] ");
    await page.waitForTimeout(500);
    ...
    await expect.soft(page.locator('.card-error')).toBeVisible();
    await expect.soft(page.locator('.card-error'))
        .toHaveText("errorInput Errorข้อมูลบรรทัดที่ 1 column 'district' selectType is equal to 1; therefore, district must not be empty. [R60] ข้อมูลบรรทัดที่ 1 column 'district' 'district' is required. [R61] Import FixesExport FixesEdit");
...
test('TC82 R60 Province Case 2 TC01 - TC03  ', async ({ page }) => {
    ...
    await expect.soft(page.getByLabel('Message')).toBeVisible();
    await expect.soft(page.getByLabel('Message'))
        .toHaveText("Messageข้อมูลบรรทัดที่ 1 column 'province' 'province' is required. [R61] ");
    await page.waitForTimeout(500);
    ...
    await expect.soft(page.locator('.card-error')).toBeVisible();
    await expect.soft(page.locator('.card-error'))
        .toHaveText("errorInput Errorข้อมูลบรรทัดที่ 1 column 'province' 'province' is required. [R61] Import FixesExport FixesEdit");
...
test('TC82 R60 Province Case 2 TC11.2 - TC13  ', async ({ page }) => {
    ...
    await expect.soft(page.getByLabel('Message')).toBeVisible();
    await expect.soft(page.getByLabel('Message'))
        .toHaveText("Messageข้อมูลบรรทัดที่ 1 column 'province' selectType is equal to 1; therefore, province must not be empty. [R60] ข้อมูลบรรทัดที่ 1 column 'province' 'province' is required. [R61] ");
    await page.waitForTimeout(500);
    ...
    await expect.soft(page.locator('.card-error')).toBeVisible();
    await expect.soft(page.locator('.card-error'))
        .toHaveText("errorInput Errorข้อมูลบรรทัดที่ 1 column 'province' selectType is equal to 1; therefore, province must not be empty. [R60] ข้อมูลบรรทัดที่ 1 column 'province' 'province' is required. [R61] Import FixesExport FixesEdit");
