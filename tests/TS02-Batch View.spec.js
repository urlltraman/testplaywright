...
test('TC11 Download Receipts ', async ({ page }) => {
  ...
  await page.reload();
  await page.waitForTimeout(1000);
  await page.getByRole('row', { name: '[91200] TS1_030724_SFTP Default Ginkgo ' }).getByLabel('').click();
...
test('TC16 Reserves Fields  ', async ({ page }) => {
  await page.waitForURL('/batch');
  await page.getByRole('button', { name: 'Upload' }).click();
  ...
  await page.getByText('Search').click();
  await page.waitForTimeout(500);
  await page.getByText('Auto_Reserves').click();
  await page.waitForTimeout(1500);
  ...
  await page.waitForTimeout(500);
  await page.screenshot({ path: 'Output/TS02-Batch View/TC16 Reserves Fields/01.Reserves Fields.png' });
  await page.waitForTimeout(1000);
  await page.locator('a').filter({ hasText: 'Batch' }).click();
  await page.waitForTimeout(1000);
  await page.getByText('Search').click();
  await page.getByRole('row', { name: 'Auto_Reserves ' }).first().getByText('delete').click();
  await page.getByRole('button', { name: 'Confirm' }).click();
