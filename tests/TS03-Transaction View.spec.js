...
test('TC02 Search Batch ID', async ({ page }) => {
  ...
  await page.waitForTimeout(1000);
  await page.getByLabel('Batch ID').fill('91200');
  await page.getByRole('button', { name: 'Filter' }).click();
  ...
  await page.waitForTimeout(1000);
  await page.getByRole('button', { name: '001TC1-Default-2024-07-0320240701' }).click();
  await expect.soft(page.getByText('E-Document No.001TC1-Default-2024-07-0320240701')).toBeVisible();
  await expect.soft(page.getByText('E-Document No.001TC1-Default-2024-07-0320240701')).toHaveText('E-Document No.001TC1-Default-2024-07-0320240701');
  await page.waitForTimeout(1000);
  ...
  await expect.soft(page.getByText('E-Document No.001TC1-Default-2024-07-0320240701QRPay-inContract No.Auto45_21Create')).toBeHidden();
  await page.waitForTimeout(1000);
...
test('TC04 Export Task Single ', async ({ page }) => {
  ...
  await page.getByRole('button', { name: 'Search' }).click();
  await page.locator('#mat-mdc-checkbox-55').click();
...
test('TC04 Export Task Multi ', async ({ page }) => {
  ...
  // await page.getByLabel('Contract No.').fill('100');
  await page.getByRole('button', { name: 'Search' }).click();
  await page.locator('#mat-mdc-checkbox-57').click();
  await page.locator('#mat-mdc-checkbox-57').click();
  await page.locator('#mat-mdc-checkbox-57').click();
  const downloadPromise = page.waitForEvent('download');
  await page.getByRole('button', { name: 'Export' }).click();
...
test('TC04 Export Receipts Single ', async ({ page }) => {
  ...
  await page.getByLabel('July 2024').click();
  await page.getByLabel('15 July 2024', { exact: true }).click();
  await page.waitForTimeout(1000);
  await page.getByRole('button', { name: 'Filter' }).click();
  await page.getByRole('menuitem', { name: 'Batch Status' }).hover();
  await page.getByRole('menuitem', { name: 'Completed' }).click();
  ...
  const download = await downloadPromise;
  // Save downloaded file somewhere
  await download.saveAs('Output/TS03-Transaction View/TC04 Export/19.Receipts Single.rar');
  await page.screenshot({ path: 'Output/TS03-Transaction View/TC04 Export/20.Receipts Single Task.png' });
  await page.waitForTimeout(1000);
...
test('TC04 Export Receipts Multi ', async ({ page }) => {
  ...
  await page.getByRole('button', { name: 'Search' }).first().click();
  await page.locator('#mat-mdc-checkbox-2').click();
  await page.locator('#mat-mdc-checkbox-3').click();
  await page.waitForTimeout(500);
  // await page.locator('#mat-mdc-checkbox-7').click();
  await page.getByRole('button', { name: 'Receipts' }).click();
  await expect(page.getByRole('heading', { name: 'You are going to download receipts' })).toHaveText('You are going to download receipts');
  await expect(page.getByRole('heading', { name: 'Ready to start..' })).toHaveText('Ready to start..');
  await page.waitForTimeout(800);
  ...
  const download = await downloadPromise;
  // Save downloaded file somewhere
  await download.saveAs('Output/TS03-Transaction View/TC04 Export/21.Receipts Multi.rar');
  await page.screenshot({ path: 'Output/TS03-Transaction View/TC04 Export/22.Receipts Multi Task.png' });
  await page.waitForTimeout(1000);
...
test('TC04 Export Receipts All ', async ({ page }) => {
  ...
  const download = await downloadPromise;
  // Save downloaded file somewhere
  await download.saveAs('Output/TS03-Transaction View/TC04 Export/23.Receipts All.rar');
  await page.screenshot({ path: 'Output/TS03-Transaction View/TC04 Export/24.Receipts All Task.png' });
  await page.waitForTimeout(1000);
...
test('TC07 Click E-Document No. ', async ({ page }) => {
  ...
  await page.getByRole('menuitem', { name: 'Contract No' }).click();
  await page.waitForTimeout(1000);
  await page.getByLabel('Contract No').fill('aklj599asdjkm6k');
  await page.getByRole('button', { name: 'Filter' }).click();
  await page.getByRole('menuitem', { name: 'Batch Status' }).hover();
  await page.getByRole('menuitem', { name: 'Completed' }).click();
  await page.getByRole('button', { name: 'Search' }).first().click();
  await page.waitForTimeout(5000);
  await page.getByRole('button', { name: '00200000aklj599asdjkm6k20240201' }).click();
  await page.waitForTimeout(1000);
  await expect(page.getByRole('dialog').getByText('E-Document No.'))
    .toHaveText('E-Document No.');
  await expect(page.getByRole('dialog').getByText('00200000aklj599asdjkm6k20240201'))
    .toHaveText('00200000aklj599asdjkm6k20240201');
  await expect(page.getByText('Contract No.aklj599asdjkm6k')).toHaveText('Contract No.aklj599asdjkm6k');
  await page.waitForTimeout(1000);
...
test('TC08 Click Contract No Basic ', async ({ page }) => {
  ...
  await page.getByRole('menuitem', { name: 'Contract No' }).click();
  await page.waitForTimeout(1000);
  await page.getByLabel('Contract No').fill('TC1-2024-06-21-8');
  await page.getByRole('button', { name: 'Filter' }).click();
  await page.getByRole('menuitem', { name: 'Batch Status' }).hover();
  await page.getByRole('menuitem', { name: 'Completed' }).click();
  await page.getByRole('button', { name: 'Search' }).first().click();
  await page.waitForTimeout(5000);
  await page.getByRole('button', { name: 'TC1-2024-06-21-8', exact: true }).click();
  await page.waitForTimeout(1000);
  await expect.soft(page.getByRole('heading', { name: 'History for \'TC1-2024-06-21-8\'' })).toBeVisible();
...
test('TC09 Reserves Fields ', async ({ page }) => {
  await page.getByRole('link', { name: 'Batch' }).click();
  await page.waitForURL('/batch');
  await page.getByRole('button', { name: 'Upload' }).click();
  await page.locator('#file').setInputFiles('Data Files/test/Auto_Reserves.xlsx');
  await page.getByRole('button', { name: 'Upload' }).click();
  ...
  await page.waitForTimeout(2500);
  await page.getByText('Reserve5').hover();
  await page.waitForTimeout(500);
  await expect.soft(page.getByText('Reserve1')).toBeVisible();
  await expect.soft(page.getByText('Reserve2')).toBeVisible();
  await expect.soft(page.getByText('Reserve3')).toBeVisible();
  await expect.soft(page.getByText('Reserve4')).toBeVisible();
  await expect.soft(page.getByText('Reserve5')).toBeVisible();
  await expect.soft(page.getByText('Reserve1')).toHaveText('Reserve1');
  await expect.soft(page.getByText('Reserve2')).toHaveText('Reserve2');
  await expect.soft(page.getByText('Reserve3')).toHaveText('Reserve3');
  await expect.soft(page.getByText('Reserve4')).toHaveText('Reserve4');
  await expect.soft(page.getByText('Reserve5')).toHaveText('Reserve5');
  await expect.soft(page.getByText('test', { exact: true })).toBeVisible();
  await expect.soft(page.getByText('ทดสอบ')).toBeVisible();
  await expect.soft(page.getByText('1234567890')).toBeVisible();
  await expect.soft(page.getByText('Testอัตโนมัติ')).toBeVisible();
  await expect.soft(page.getByText('A1b2ก5ข4')).toBeVisible();
  await expect.soft(page.getByText('test', { exact: true })).toHaveText('test');
  await expect.soft(page.getByText('ทดสอบ')).toHaveText('ทดสอบ');
  await expect.soft(page.getByText('1234567890')).toHaveText('1234567890');
  await expect.soft(page.getByText('Testอัตโนมัติ')).toHaveText('Testอัตโนมัติ');
  await expect.soft(page.getByText('A1b2ก5ข4')).toHaveText('A1b2ก5ข4');
  await page.waitForTimeout(500);
  await page.screenshot({ path: 'Output/TS03-Transaction View/TC09 Reserves Fields/01.Reserves Fields.png' });
  await page.waitForTimeout(1000);
  await page.locator('a').filter({ hasText: 'Batch' }).click();
  await page.waitForTimeout(1000);
  await page.getByText('Search').click();
  await page.locator('tr').filter({ hasText: 'Auto_Reserves' }).locator('button').nth(1).click();
  await page.getByRole('button', { name: 'Confirm' }).click();
  await expect.soft(page.getByRole('row', { name: 'Auto_Reserves  ' })).toBeHidden();
  await page.waitForTimeout(1000);
