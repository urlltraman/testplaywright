...
test('TC18 Tax Payer Relationship 01 - 10  ', async ({ page }) => {
    // C1
    await page.waitForURL('http://gestamp.ddns.net/gestamp/#/batch');
    await page.getByRole('button', { name: 'Upload' }).first().click();
...
test('TC19 Country ID 01 - 10 ', async ({ page }) => {
    // C1
    await page.waitForURL('http://gestamp.ddns.net/gestamp/#/batch');
    await page.getByRole('button', { name: 'Upload' }).first().click();
...
test('TC19 Country ID 11 - 21  ', async ({ page }) => {
    // C11
    await page.waitForURL('http://gestamp.ddns.net/gestamp/#/batch');
    await page.getByRole('button', { name: 'Upload' }).first().click();
...
test('TC20 contract branch case 1  ', async ({ page }) => {
    //  C1
    await page.waitForURL('http://gestamp.ddns.net/gestamp/#/batch');
    await page.getByRole('button', { name: 'Upload' }).first().click();
    ...
    await expect.soft(page.getByLabel('Message')).toBeVisible();
    await expect.soft(page.getByLabel('Message'))
        .toHaveText("Messageข้อมูลบรรทัดที่ 1 column 'contractPartyBranchType' length is overflow ข้อมูลบรรทัดที่ 1 column 'contractPartyBranchType' value must be one of 'V,S,O' ข้อมูลบรรทัดที่ 1 column 'contractPartyBranchType' contractPartyBranchNo is equal to 0; therefore, contractPartyBranchType must be 'O' [R13] ");
    await page.waitForTimeout(500);
    ...
    await expect.soft(page.locator('.card-error')).toBeVisible();
    await expect.soft(page.locator('.card-error'))
        .toHaveText("errorInput Errorข้อมูลบรรทัดที่ 1 column 'contractPartyBranchType' length is overflow ข้อมูลบรรทัดที่ 1 column 'contractPartyBranchType' value must be one of 'V,S,O' ข้อมูลบรรทัดที่ 1 column 'contractPartyBranchType' contractPartyBranchNo is equal to 0; therefore, contractPartyBranchType must be 'O' [R13] Import FixesExport FixesEdit");
    await page.waitForTimeout(500);
...
test('TC20 contract branch case 2  ', async ({ page }) => {
    //  C1
    await page.waitForURL('http://gestamp.ddns.net/gestamp/#/batch');
    await page.getByRole('button', { name: 'Upload' }).first().click();
    ...
    await expect.soft(page.getByLabel('Message')).toBeVisible();
    await expect.soft(page.getByLabel('Message'))
        .toHaveText("Messageข้อมูลบรรทัดที่ 1 column 'contractPartyBranchType' length is overflow ข้อมูลบรรทัดที่ 1 column 'contractPartyBranchType' value must be one of 'V,S,O' ข้อมูลบรรทัดที่ 1 column 'contractPartyBranchType' contractPartyBranchNo is empty; therefore, contractPartyBranchType must be 'O' [R13] ");
    await page.waitForTimeout(500);
    ...
    await expect.soft(page.locator('.card-error')).toBeVisible();
    await expect.soft(page.locator('.card-error'))
        .toHaveText("errorInput Errorข้อมูลบรรทัดที่ 1 column 'contractPartyBranchType' length is overflow ข้อมูลบรรทัดที่ 1 column 'contractPartyBranchType' value must be one of 'V,S,O' ข้อมูลบรรทัดที่ 1 column 'contractPartyBranchType' contractPartyBranchNo is empty; therefore, contractPartyBranchType must be 'O' [R13] Import FixesExport FixesEdit");
    await page.waitForTimeout(500);
    ...
    await page.screenshot({ path: 'Output/TS11-Input Validation/TC20. ContractBranch/Case 2/26. case 20.png', mask: [mask_locator9], maskColor: '#00FF00' });
    await page.waitForTimeout(1500);
    await page.getByRole('button', { name: 'Search' }).first().click();
    await page.waitForTimeout(500);
    await page.reload();
    ...
    await expect.soft(page.getByLabel('Message'))
        .toHaveText("Messageข้อมูลบรรทัดที่ 1 column 'contractPartyBranchType' length is overflow ข้อมูลบรรทัดที่ 1 column 'contractPartyBranchType' value must be one of 'V,S,O' ข้อมูลบรรทัดที่ 1 column 'contractPartyBranchType' contractPartyBranchNo is empty; therefore, contractPartyBranchType must be 'O' [R13] ");
    await page.waitForTimeout(500);
    await page.screenshot({ path: 'Output/TS11-Input Validation/TC20. ContractBranch/Case 2/27. case 20 Click Status Error Msg.png' });
    await page.waitForTimeout(500);
    await page.reload();
    ...
    await expect.soft(page.locator('.card-error'))
        .toHaveText("errorInput Errorข้อมูลบรรทัดที่ 1 column 'contractPartyBranchType' length is overflow ข้อมูลบรรทัดที่ 1 column 'contractPartyBranchType' value must be one of 'V,S,O' ข้อมูลบรรทัดที่ 1 column 'contractPartyBranchType' contractPartyBranchNo is empty; therefore, contractPartyBranchType must be 'O' [R13] Import FixesExport FixesEdit");
    await page.waitForTimeout(500);
    await page.screenshot({ path: 'Output/TS11-Input Validation/TC20. ContractBranch/Case 2/28. case 20 Error Msg.png' });
    await page.locator('a').filter({ hasText: 'Batch' }).click();
    ...
    await page.screenshot({ path: 'Output/TS11-Input Validation/TC20. ContractBranch/Case 2/29. case 21.png', mask: [mask_locator10], maskColor: '#00FF00' });
    await page.waitForTimeout(1500);
    await page.getByRole('button', { name: 'Search' }).first().click();
    await page.waitForTimeout(500);
    await page.reload();
    ...
    await expect.soft(page.getByLabel('Message'))
        .toHaveText("Messageข้อมูลบรรทัดที่ 1 column 'contractPartyBranchType' length is overflow ข้อมูลบรรทัดที่ 1 column 'contractPartyBranchType' value must be one of 'V,S,O' ข้อมูลบรรทัดที่ 1 column 'contractPartyBranchType' contractPartyBranchNo is empty; therefore, contractPartyBranchType must be 'O' [R13] ");
    await page.waitForTimeout(500);
    await page.screenshot({ path: 'Output/TS11-Input Validation/TC20. ContractBranch/Case 2/30. case 21 Click Status Error Msg.png' });
    await page.waitForTimeout(500);
    await page.reload();
    ...
    await expect.soft(page.locator('.card-error'))
        .toHaveText("errorInput Errorข้อมูลบรรทัดที่ 1 column 'contractPartyBranchType' length is overflow ข้อมูลบรรทัดที่ 1 column 'contractPartyBranchType' value must be one of 'V,S,O' ข้อมูลบรรทัดที่ 1 column 'contractPartyBranchType' contractPartyBranchNo is empty; therefore, contractPartyBranchType must be 'O' [R13] Import FixesExport FixesEdit");
    await page.waitForTimeout(500);
    await page.screenshot({ path: 'Output/TS11-Input Validation/TC20. ContractBranch/Case 2/31. case 21 Error Msg.png' });
    await page.locator('a').filter({ hasText: 'Batch' }).click();
...
test('TC20 contract branch case 3  ', async ({ page }) => {
    //  C1
    await page.waitForURL('http://gestamp.ddns.net/gestamp/#/batch');
    await page.getByRole('button', { name: 'Upload' }).first().click();
    ...
    await page.screenshot({ path: 'Output/TS11-Input Validation/TC20. ContractBranch/Case 3/26. case 20.png', mask: [mask_locator9], maskColor: '#00FF00' });
    await page.waitForTimeout(1500);
    await page.getByRole('button', { name: 'Search' }).first().click();
    await page.waitForTimeout(500);
    await page.reload();
    ...
    await expect.soft(page.getByLabel('Message'))
        .toHaveText("Messageข้อมูลบรรทัดที่ 1 column 'contractPartyBranchType' length is overflow ข้อมูลบรรทัดที่ 1 column 'contractPartyBranchType' value must be one of 'V,S,O' ข้อมูลบรรทัดที่ 1 column 'contractPartyBranchType' contractPartyBranchNo is empty; therefore, contractPartyBranchType must be 'O' [R13] ");
    await page.waitForTimeout(500);
    await page.screenshot({ path: 'Output/TS11-Input Validation/TC20. ContractBranch/Case 3/27. case 20 Click Status Error Msg.png' });
    await page.waitForTimeout(500);
    await page.reload();
    ...
    await expect.soft(page.locator('.card-error'))
        .toHaveText("errorInput Errorข้อมูลบรรทัดที่ 1 column 'contractPartyBranchType' length is overflow ข้อมูลบรรทัดที่ 1 column 'contractPartyBranchType' value must be one of 'V,S,O' ข้อมูลบรรทัดที่ 1 column 'contractPartyBranchType' contractPartyBranchNo is empty; therefore, contractPartyBranchType must be 'O' [R13] Import FixesExport FixesEdit");
    await page.waitForTimeout(500);
    await page.screenshot({ path: 'Output/TS11-Input Validation/TC20. ContractBranch/Case 3/28. case 20 Error Msg.png' });
    await page.locator('a').filter({ hasText: 'Batch' }).click();
    ...
    await page.screenshot({ path: 'Output/TS11-Input Validation/TC20. ContractBranch/Case 3/29. case 21.png', mask: [mask_locator10], maskColor: '#00FF00' });
    await page.waitForTimeout(1500);
    await page.getByRole('button', { name: 'Search' }).first().click();
    await page.waitForTimeout(500);
    await page.reload();
    ...
    await expect.soft(page.getByLabel('Message'))
        .toHaveText("Messageข้อมูลบรรทัดที่ 1 column 'contractPartyBranchType' length is overflow ข้อมูลบรรทัดที่ 1 column 'contractPartyBranchType' value must be one of 'V,S,O' ข้อมูลบรรทัดที่ 1 column 'contractPartyBranchType' contractPartyBranchNo is empty; therefore, contractPartyBranchType must be 'O' [R13] ");
    await page.waitForTimeout(500);
    await page.screenshot({ path: 'Output/TS11-Input Validation/TC20. ContractBranch/Case 3/30. case 21 Click Status Error Msg.png' });
    await page.waitForTimeout(500);
    await page.reload();
    ...
    await expect.soft(page.locator('.card-error'))
        .toHaveText("errorInput Errorข้อมูลบรรทัดที่ 1 column 'contractPartyBranchType' length is overflow ข้อมูลบรรทัดที่ 1 column 'contractPartyBranchType' value must be one of 'V,S,O' ข้อมูลบรรทัดที่ 1 column 'contractPartyBranchType' contractPartyBranchNo is empty; therefore, contractPartyBranchType must be 'O' [R13] Import FixesExport FixesEdit");
    await page.waitForTimeout(500);
    await page.screenshot({ path: 'Output/TS11-Input Validation/TC20. ContractBranch/Case 3/31. case 21 Error Msg.png' });
    await page.locator('a').filter({ hasText: 'Batch' }).click();
...
test('TC20 contract branch case 4  ', async ({ page }) => {
    //  C1
    await page.waitForURL('http://gestamp.ddns.net/gestamp/#/batch');
    await page.getByRole('button', { name: 'Upload' }).first().click();
...
test('TC20 contract branch case 5  ', async ({ page }) => {
    //  C1
    await page.waitForURL('http://gestamp.ddns.net/gestamp/#/batch');
    await page.getByRole('button', { name: 'Upload' }).first().click();
...
test('TC20 contract branch case 6  ', async ({ page }) => {
    //  C1
    await page.waitForURL('http://gestamp.ddns.net/gestamp/#/batch');
    await page.getByRole('button', { name: 'Upload' }).first().click();
...
test('TC20 contract branch case 7  ', async ({ page }) => {
    //  C1
    await page.waitForURL('http://gestamp.ddns.net/gestamp/#/batch');
    await page.getByRole('button', { name: 'Upload' }).first().click();
...
test('TC20 contract branch case 8  ', async ({ page }) => {
    //  C1
    await page.waitForURL('http://gestamp.ddns.net/gestamp/#/batch');
    await page.getByRole('button', { name: 'Upload' }).first().click();
...
test('TC20 contract branch case 9  ', async ({ page }) => {
    //  C1
    await page.waitForURL('http://gestamp.ddns.net/gestamp/#/batch');
    await page.getByRole('button', { name: 'Upload' }).first().click();
...
test('TC20 contract branch case 10  ', async ({ page }) => {
    //  C1
    await page.waitForURL('http://gestamp.ddns.net/gestamp/#/batch');
    await page.getByRole('button', { name: 'Upload' }).first().click();
