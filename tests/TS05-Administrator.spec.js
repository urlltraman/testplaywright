...
test('TC06 Company Details ', async ({ page }) => {
  ...
  await page.waitForTimeout(1000);
  await page.getByRole('button', { name: 'INFO' }).nth(2).click();
  ...
  await page.screenshot({ path: 'Output/TS05-Administrator/TC06 Company/01.Info.png' });
  await page.waitForTimeout(1000);
  await page.getByRole('button', { name: 'Cancel' }).click();
  await page.waitForTimeout(1000);
  await page.screenshot({ path: 'Output/TS05-Administrator/TC06 Company/02.Info Click Cancle.png' });
  await page.waitForTimeout(1000);
  await page.getByRole('button', { name: 'KEY' }).nth(2).click();
  await expect(page.getByText('Key Store Key visibility_off')).toBeEnabled();  
  await expect(page.getByText('Key Store Pass visibility_off')).toBeEnabled();
  await page.screenshot({ path: 'Output/TS05-Administrator/TC06 Company/03.Key.png' });
  await page.waitForTimeout(1000);
  await page.getByRole('button', { name: 'Cancel' }).click();
  await page.waitForTimeout(1000);
  await page.screenshot({ path: 'Output/TS05-Administrator/TC06 Company/04.Key Click Cancle.png' });
  await page.waitForTimeout(1000);
