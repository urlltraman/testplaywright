...
test.beforeEach(async ({ page }) => {
    ...
    await page.waitForURL('https://app.gestampduty.com/admin');
});
...
// test.beforeEach(async ({ page }) => {
//     // Runs before each test and signs in each page.
//     await page.goto('https://app.gestampduty.com/admin');
// });
...
test('TC03 Delete User ', async ({ page }) => {
    ...
    await page.getByRole('row', { name: 'Au*****er te*****om GDM' }).getByRole('button').nth(2).click();
    await page.waitForTimeout(800);
...
test('TC07 Schedule Submit ', async ({ page }) => {
    ...
    await page.getByRole('tab', { name: 'Schedule Submit' }).click();
    await page.waitForTimeout(1000);
