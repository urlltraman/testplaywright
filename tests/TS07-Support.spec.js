...
test('TC05 Search Input Log Channel ', async ({ page }) => {
    ...
    await page.getByRole('button', { name: 'Search' }).click();
    await page.waitForTimeout(500);
    await page.screenshot({ path: 'Output/TS07-Support/TC05 Search Input Log/01.Channel/04.SFTP.png' });
...
test('TC07 Search Submit Log Channel ', async ({ page }) => {
    ...
    await page.getByRole('link', { name: 'Submit Log' }).click();
    await page.waitForTimeout(1000);
    await page.locator('div').filter({ hasText: /^ChannelAll$/ }).nth(1).click();
    await page.getByRole('option', { name: 'All' }).click();
    await page.getByRole('button', { name: 'Search' }).click();
    await page.waitForTimeout(500);
    ...
    await page.locator('div').filter({ hasText: /^ChannelScheduled Submit$/ }).nth(1).click();
    ...
    await page.locator('div').filter({ hasText: /^ChannelManual Submit$/ }).nth(1).click();
...
test('TC07 Search Submit Log Company', async ({ page }) => {
    ...
    await page.getByRole('button', { name: 'Search' }).click();
    await page.waitForTimeout(500);
    await page.screenshot({ path: 'Output/TS07-Support/TC07 Search Submit Log/04.Company/03.GDM Company.png' });
...
test('TC07 Search Submit Log Search ', async ({ page }) => {
    ...
    await page.getByLabel('Search').first().fill('E072');
    await page.getByRole('button', { name: 'Search' }).first().click();
    await page.waitForTimeout(500);
    ...
    await page.getByLabel('Search').first().fill('API000000000000');
    await page.getByRole('button', { name: 'Search' }).first().click();
    await page.waitForTimeout(500);
...
test('TC11 Search Event Log Log Type ', async ({ page }) => {
    ...
    await page.locator('div').filter({ hasText: /^Log typeINFO$/ }).nth(1).click();
    ...
    await page.locator('div').filter({ hasText: /^Log typeDEBUG$/ }).nth(1).click();
    ...
    await page.locator('div').filter({ hasText: /^Log typeWARN$/ }).nth(1).click();
